...
let Ford: Auto = new Auto ("Ford", "Ka", 2010, "Rojo", 3);
let Gilera: Moto = new Moto ("Gilera", "Smash Tunnig", 2022, "Azul",125);
let Siena: Auto= new Auto ("Fiat", "Siena", 2019, "Gris", 5);
let Scania: Camion = new Camion ("Scania", "R 450",2011, "Blanco", 2, 800);
...
let anio: number = rls.question("Ingrese el año de fabricación del vehículo: ");
let color: string = rls.question("Ingrese el color del vehículo:\n");
let nuevaMoto: Moto = new Moto(marca,modelo,anio,color,125);


// y la agregamos al registro
